...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:variable name="top_metadata">
    <ul>
      ...
      <li><strong>Editorial note(s): </strong><xsl:apply-templates select="//teiHeader/fileDesc/notesStmt/note[@type='work_relations']"/> </li>
      ...
      <li><xsl:apply-templates select="//teiHeader/fileDesc/notesStmt/note[@type='project']"/></li>
